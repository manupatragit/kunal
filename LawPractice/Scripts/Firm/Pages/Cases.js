function CasesController() {
    ...
    var privateMethods = {
        ...
        getlist: function (additinalData) {
            Utility.postDataToServer("api/FirmApi/FirmCasesList", {}, {}, "json", privateMethods.loadList, null, additinalData, false);
        },
    ...
    constructor.CasesController();
}

$(document).ready(function () {
    var main = new CasesController();
});