...
{
    public class DirectoryListController : ApiController
    {
        ...
        public IHttpActionResult Get()
        {
            ...
            //  var listdir = db.ViewFiles.Where(x=>x.Firmuser == userid && x.ftype == 0).ToList();
            var listdir = db.GetDirectoryApi(Guid.Parse(userid.ToString())).ToList();
