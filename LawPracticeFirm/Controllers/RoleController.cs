...
{
    public class RoleController : BaseFirmController
    {
        LawPracticeEntities context;
        public RoleController()
        {
            context = new LawPracticeEntities();
        }
        /// <summary>  
        /// Get All Roles  
        /// </summary>  
        ...
        public ActionResult Creat2e()
        {
            var Role = new IdentityRole();
            return View(Role);
        }
        public ActionResult Cr4eat2e()
        {
            var Role = new IdentityRole();
            return View(Role);
        }
        ...
        /// <returns></returns>
        [AuthLog(Roles = "Firm,User")]
        public ActionResult RoleAccessCreate()
        {
            ViewBag.pagesize = System.Configuration.ConfigurationManager.AppSettings["pagesize"];
            return View();
        }
        ...
        /// <returns></returns>
        [AuthLog(Roles = "Firm,User")]
        public ActionResult RoleAccessUpdate()
        {
            string id = QueryAES.UrlDecode(Request.Form["id"]);
            if (String.IsNullOrEmpty(id))
            {
                return RedirectToAction("Unauthorise", "home");
            }
            string op = QueryAES.UrlDecode(Request.Form["op"]);
            string gname = QueryAES.UrlDecode(Request.Form["gname"]);
            ViewBag.id = id;
            ViewBag.op = op;
            ViewBag.gname = gname;
            ViewBag.pagesize = System.Configuration.ConfigurationManager.AppSettings["pagesize"];
        ...
        /// <summary>
        /// Create case role access details
        /// </summary>
        /// <returns></returns>
        [AuthLog(Roles = "Firm,User")]
        public ActionResult CaseRoleAccessCreate()
        {
            ViewBag.pagesize = System.Configuration.ConfigurationManager.AppSettings["pagesize"];
            return View();
        }
        /// <summary>
        /// Update case role access
        /// </summary>
        /// <returns></returns>
        [AuthLog(Roles = "Firm,User")]
        public ActionResult CaseRoleAccessUpdate()
        {
            string id = QueryAES.UrlDecode(Request.Form["id"]);
            if (String.IsNullOrEmpty(id))
            {
            ...
            string op = QueryAES.UrlDecode(Request.Form["op"]);
            string editcaseid = QueryAES.UrlDecode(Request.Form["editcaseid"]);
            string pageid = QueryAES.UrlDecode(Request.Form["pageid"]);
            ViewBag.id = id;
            ViewBag.op = op;
            ViewBag.editcaseid = editcaseid;
            ViewBag.pageid = pageid;
            ViewBag.pagesize = System.Configuration.ConfigurationManager.AppSettings["pagesize"];
            return View();
        }
        /// <summary>
        /// Get case role access
        /// </summary>
        /// <returns></returns>
        [AuthLog(Roles = "Firm,User")]
        public ActionResult CaseRoleAccess()
        {
            ViewBag.pagesize = System.Configuration.ConfigurationManager.AppSettings["pagesize"];
            if (LoggedInUser.RoleId == 2)
            {
