...
(function (jQuery) {
    ...
    function build(options) {
        ...
        function build() {
            ...
            opts.start = new Date(startyearcalendar, startmonthcalendar, startdatecalendar);
                ...
                for (var j = 0; j < data[i].series.length; j++) {
                    ...
                    var block = jQuery("<div>", {
                        ...
                        "css": {
                            ...
                            "margin-left": ((offset * cellWidth) - 10) + "px"
                        }
                    });
                    ...
                    //block.append(jQuery("<div >", { "class": "ganttview-block-text" }).text("20%"));
