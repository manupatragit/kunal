        ...
        function addVtHeader(div, data, cellHeight) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                for (var j = 0; j < data[i].series.length; j++) {
                    ...
                    //alert(data[i].series[j].name);// right side data
                }
        ...
        function addBlocks(div, data, cellWidth, start) {
            ...
            for (var i = 0; i < data.length; i++) {
                for (var j = 0; j < data[i].series.length; j++) {
                    ...
                    //alert(series.start + ',' + series.end); // startdate enddate
                    ...
                    //alert(size); //showing number of plan
    ...
    var DateUtils = {
        ...
        getBoundaryDatesFromData: function (data, minDays) {
            ...
            $.ajax({
                async: true,
                type: "POST",
                url: "/api/PublicApi/LoadGanttMasterData",
                dataType: 'json',
                data: formData,
                contentType: false,
                processData: false,
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                $.ajax({
                    async: true,
                    type: "POST",
                    url: "/api/PublicApi/LoadGanttChartData?id=" + data[i].Id,
                    dataType: 'json',
                    data: formData1,
                    contentType: false,
                    processData: false,
                    ...
                    success: function (response) {
                        ...
                        alert("datelen: " + dateData.length);
                    }

                });
               
                for (var j = 0; j < dateData.length; j++) {
                    //var start = Date.parse(dateData[j].StartDate);
                    //var end = Date.parse(dateData[j].EndDate)
                    alert(dateData[j].StartDate);
