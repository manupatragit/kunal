...
$(document).ready(function () {
    ...
    function GeneratedItemsTableAll() {
        ...
        if (orderItems.length > 0) {
            ...
            $table2.append('<thead><tr><th><div class="thbg">Particular</div></th><th><div class="thbg">Billed By</div></th><th><div class="thbg">Amount</div></th><th><div class="thbg">Action</th></tr></thead>');
            var $tbody2 = $('<tbody/>');
            $.each(orderItems, function (i, val) {
    ...
    $("#createinv").click(function () {
        ...
        $.ajax({
            url: '/api/OcrInvoiceApi/RecurrenceInvoice',
            data: formData,
            contentType: false,
            processData: false,
            type: 'POST',
    ...
    /*Load client adddress by client id*/
