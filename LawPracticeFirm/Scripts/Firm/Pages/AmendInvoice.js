...
$(document).ready(function () {
    ...
    /*Generated Items Table All*/
    function GeneratedItemsTableAll() {
        var temptotsum1 = 0;
        var temptotsum2 = 0;
        var temptotsum3 = 0;
        if (orderItems.length > 0) {
            var $table = $('<table id="table1" class="table-panel"/>');
            $table.append('<thead><tr><th><div class="thbg">Item Name</div></th><th><div class="thbg">Case Name</div></th><th><div class="thbg">Billed By</div></th><th><div class="thbg">Price</div></th><th><div class="thbg">Quantity</div></th><th><div class="thbg">Total</div></th><th><div class="thbg"></div></th><th><div class="thbg"></div></th></tr></thead>');
            var $tbody = $('<tbody/>');
            $.each(orderItems, function (i, val) {
                if (val.type == "FlatFees") {
                    ...
                    var $edit = $('<a title="Edit" href="#" entryid="' + val.Iid + '"  invoiceid="' + val.InvoiceId + '" casetoken="' + val.caseid + '" billtoken="' + val.billyby + '" data-val="' + (parseFloat(val.QtyORHour) * parseFloat(val.price).toFixed(2)) + '"><span><img src="/newassets/img/editmatter.png"></span></a>');
                    var $remove = $('<a title="Remove" href="#" data-val="' + (parseFloat(val.QtyORHour) * parseFloat(val.price).toFixed(2)) + '"><span><img src="/newassets/img/deletematter.png"></span></a>');
        ...
        if (orderItems.length > 0) {
            ...
            $.each(orderItems, function (i, val) {
                if (val.type == "TimeEntries") {
                    ...
                    var $edit2 = $('<a title="Edit" href="#" entryid="' + val.Iid + '"  invoiceid="' + val.InvoiceId + '" casetoken="' + val.caseid + '" billtoken="' + val.billyby + '" data-val="' + (parseFloat(val.QtyORHour) * parseFloat(val.price).toFixed(2)) + '"><span><img src="/newassets/img/editmatter.png"></span></a>');
                    var $remove2 = $('<a title="Remove" href="#" data-val="' + (parseFloat(val.QtyORHour) * parseFloat(val.price).toFixed(2)) + '"><span><img src="/newassets/img/deletematter.png"></span></a>');
        ...
        if (orderItems.length > 0) {
            var $table3 = $('<table id="table3" class="table-panel"/>');
            $table3.append('<thead><tr><th><div class="thbg">Particular</div></th><th><div class="thbg">Matter Name</div></th><th><div class="thbg">Billed By</div></th><th><div class="thbg">Price</div></th><th><div class="thbg">Quantity</div></th><th><div class="thbg">Total</div></th><th><div class="thbg"></div></th><th><div class="thbg"></div></th></tr></thead>');
            var $tbody3 = $('<tbody/>');
            $.each(orderItems, function (i, val) {
                if (val.type == "Expense") {
                    var $row3 = $('<tr/>');
                    ...
                    var $edit3 = $('<a title="Edit" href="#" entryid="' + val.Iid + '"  invoiceid="' + val.InvoiceId + '" casetoken="' + val.caseid + '" billtoken="' + val.billyby + '" data-val="' + (parseFloat(val.QtyORHour) * parseFloat(val.price).toFixed(2)) + '"><span><img src="/newassets/img/editmatter.png"></span></a>');
                    var $remove3 = $('<a title="Remove" href="#" data-val="' + (parseFloat(val.QtyORHour) * parseFloat(val.price).toFixed(2)) + '"><span><img src="/newassets/img/deletematter.png"></span></a>');
...
/*Load state by client Id*/
    ...
    function GeneratedItemsTable4() {
        if (payorderItems.length > 0) {
            ...
            $.each(payorderItems, function (i, val) {
                ...
                var $remove4 = $('<a href="#" ><span><img src="/newassets/img/deletematter.png"></span></a>');
    ...
    function GeneratedItemsTable1() {
        ...
        var temptotsum1 = 0;
        if (orderItems.length > 0) {
            var $table1 = $('<table id="table1" class="table-panel"/>');
            $table1.append('<thead><tr><th><div class="thbg">Item Name</div></th><th><div class="thbg">Case Name</div></th><th><div class="thbg">Billed By</div></th><th><div class="thbg">Price</div></th><th><div class="thbg">Quantity</div></th><th><div class="thbg">Total</div></th><th><div class="thbg"></div></th><th><div class="thbg"></div></th></tr></thead>');
            var $tbody1 = $('<tbody/>');
            $.each(orderItems, function (i, val) {
                if (val.type == "FlatFees") {
                    var $row = $('<tr/>');
                    ...
                    $row.append($('<td/>').html((parseFloat(val.QtyORHour) * parseFloat(val.price).toFixed(2))));
                    temptotsum1 = parseFloat(temptotsum1) + (parseFloat(val.QtyORHour) * parseFloat(val.price).toFixed(2));
                    var $edit1 = $('<a title="Edit" href="#" entryid="' + val.Iid + '" invoiceid="' + val.InvoiceId + '" casetoken="' + val.caseid + '" billtoken="' + val.billyby + '" data-val="' + (parseFloat(val.QtyORHour) * parseFloat(val.price).toFixed(2)) + '"><span><img src="/newassets/img/editmatter.png"></span></a>');
                    var $remove1 = $('<a href="#" data-val="' + val.TotalAmount + '"><span><img src="/newassets/img/deletematter.png"></span></a>');
    ...
    $('#add2').click(function () {
        ...
        if (isValidItem) {
            orderItems.push({
                ...
                Firmid: "",
                userid: "",
                //QtyORHour: parseFloat($('#quantity2').val().trim()),
                billedbyname: $('#UserName2').find('option:selected').attr('tempname'),
                billyby: NewUserName2.trim(),
                //caseid: $('#CaseName2').val().trim(),
                //casename: $('#CaseName2').find('option:selected').attr('tempname'),
                date_time: "",
        ...
        if (orderItems.length > 0) {
            ...
            $.each(orderItems, function (i, val) {
                if (val.type == "TimeEntries") {
                    var $row2 = $('<tr/>');
                    $row2.append($('<td/>').html(val.itemname));
                    //$row2.append($('<td/>').html(val.casename));
                    $row2.append($('<td/>').html(val.billedbyname));
                    $row2.append($('<td/>').html(val.price));
                    var $edit2 = $('<a title="Edit" href="#" entryid="' + val.Iid + '" invoiceid="' + val.InvoiceId + '" casetoken="' + val.caseid + '" billtoken="' + val.billyby + '" data-val="' + parseFloat(val.price).toFixed(2) + '"><span><img src="/newassets/img/editmatter.png"></span></a>');
                    temptotsum2 = (parseFloat(val.price) + parseFloat(temptotsum2)).toFixed(2);
                    var $remove2 = $('<a title="Remove" href="#" data-val="' + parseFloat(val.price).toFixed(2) + '"><span><img src="/newassets/img/deletematter.png"></span></a>');
                    $remove2.click(function (e) {
                        var result = confirm("Are you sure want to delete items ?");
                        if (result) {
                            e.preventDefault();
                    ...
                    $edit2.click(function (e) {
                        ...
                        var par2 = $(this).parent().parent(); //tr
                        var ItemName2 = par2.children("td:nth-child(1)");
                        //var CaseName2 = par2.children("td:nth-child(2)");
                        var Billby2 = par2.children("td:nth-child(2)");
                        var Price2 = par2.children("td:nth-child(3)");
                        var Total2 = par2.children("td:nth-child(4)");
                        var edit2 = par2.children("td:nth-child(5)");
                        //var casetoken2 = $(this).attr("casetoken");
                        var billtoken2 = $(this).attr("billtoken");
                        tempinvid2 = $(this).attr("invoiceid");
                        tempentryid2 = $(this).attr("entryid");
                        $("#itemName2").val(ItemName2.html());
                        //$("#CaseName2").val(casetoken2);
                        $("#UserName2").val(billtoken2);
                        $("#price2").val(Price2.html());
                        $("#add2").css("display", "none");
                        $("#edit2").css("display", "");
    ...
    function GeneratedItemsTable3() {
        ...
        if (orderItems.length > 0) {
            var $table3 = $('<table id="table3" class="table-panel"/>');
            $table3.append('<thead><tr><th><div class="thbg">Item Name</div></th><th><div class="thbg">Case Name</div></th><th><div class="thbg">Billed By</div></th><th><div class="thbg">Price</div></th><th><div class="thbg">Quantity</div></th><th><div class="thbg">Total</div></th><th><div class="thbg"></div></th><th><div class="thbg"></div></th></tr></thead>');
            var $tbody3 = $('<tbody/>');
            $.each(orderItems, function (i, val) {
                if (val.type == "Expense") {
                    var $row3 = $('<tr/>');
                    ...
                    temptotsum3 = parseFloat(temptotsum3) + (parseFloat(val.QtyORHour) * parseFloat(val.price).toFixed(2));
                    var $edit3 = $('<a title="Edit" href="#" entryid="' + val.Iid + '" invoiceid="' + val.InvoiceId + '" casetoken="' + val.caseid + '" billtoken="' + val.billyby + '" data-val="' + (parseFloat(val.QtyORHour) * parseFloat(val.price).toFixed(2)) + '"><span><img src="/newassets/img/editmatter.png"></span></a>');
                    var $remove3 = $('<a href="#" data-val="' + val.TotalAmount + '"><span><img src="/newassets/img/deletematter.png"></span></a>');
                    $remove3.click(function (e) {
                        e.preventDefault();
                        orderItems.splice(i, 1);
                        var sum31 = parseFloat($("#total3").text()) - parseFloat($(this).attr("data-val"));
    ...
    $('#edit2').click(function () {
        ...
        if (isValidItem) {
            ...
            //orderItems[objIndex].QtyORHour = parseFloat($('#quantity2').val().trim());
            ...
            //orderItems[objIndex].caseid = $('#CaseName2').val().trim();
            //orderItems[objIndex].casename = $('#CaseName2').find('option:selected').attr('tempname');
            orderItems[objIndex].itemname = $('#itemName2').val().trim();
            orderItems[objIndex].price = parseFloat($('#price2').val().trim());
            //orderItems[objIndex].CaseName = $('#CaseName2').val().trim();
            orderItems[objIndex].UserName = NewUserName2.trim();
            //orderItems[objIndex].Quantity = parseFloat($('#quantity2').val().trim());
            orderItems[objIndex].Price = parseFloat($('#price2').val().trim());
            orderItems[objIndex].TotalAmount = (parseFloat($('#price2').val().trim()).toFixed(2));
            //orderItems[objIndex].tempCaseName = $('#CaseName2').find('option:selected').attr('tempname');
    ...
    $("#createinv").click(function () {
        ...
        if (invclient == "00000000-0000-0000-0000-000000000000") {
            invclient = $("#client").val();
        }
        if (UserNameFreeText == "") {
        ...
        formData.append("token", EncodeText($("#invcid").val()));
        ...
        $.ajax({
            url: '/api/OcrInvoiceApi/SaveAmendInvoice',
            data: formData,
            contentType: false,
            processData: false,
            type: 'POST',
            success: function (response) {
                ...
                if (response.Status == true) {
                    ...
                    if (response.Data == "Invoice Series not found") {
                        ...
                        alert("You can edit an invoice only 5 times.")
                    }
                    else {
                        new PNotify({
                            title: 'Success!',
                            text: ' Invoice Amend successfully',
                            type: 'success',
                            delay: 3000
                        });
