$(document).ready(function () {
    ...
    $(document).on("click", "#transferpage", function () {
        ...
        var urls = "/" + fcode + "/Firm/CustomFormDataUpdate";
        url_redirect({
            url: urls,
            method: "post",
            ...
            var rt1 = $.ajax({
                ...
                success: function (response) {
                    ...
                    $.each(obj, function (i, val) {
                        it = it + 1;
                        var $row = $('<tr />');
                        $row.append($('<td class="s" />').html("<span><a id='transferpage' href='javascript:void()' cid=" + val.cid + " ftoken=" + id + " wftoken=" + wftoken + ">Edit</a>"));
