$(document).ready(function () {
    ...
    function loadtabledata(pageindex) {
        ...
        formdata.append("search", $('#txtsearchdata').val());
        $.ajax({
            async: true,
                            ...
                            try {
                                if (String(mfile) != "") {
                                    ...
                                    for (var i = 0; i < str_array1.length; i++) {
                                        ...
                                        // $(".shfile" + val.mid + q1).not(':first').remove();
                                    }
                                }
                            }
                            catch (err) {
            ...
            success: function (response) {
                if (response.Status == true) {
                    ...
                    $.each(obj, function (i, val) {
                        ...
                        // alert(subdata);
                        //if (subdata != val.shareby) {
                        $("#touser" + val.MessageId).append(" " + val.shareby + ", ");
                        //$("#touserreply" + val.MessageId).append(" " + val.shareby + ", ");
                        // }
                    });
                }
                else {
