...
$(document).ready(function () {
    ...
    function LoadCourtDropdown() {
        ...
        $.ajax({
            ...
            url: "/api/MatterApi/IOCLGrahDataCourtList",
            contentType: false,
            processData: false,
    ...
    function LoadStatusDropdown() {
        ...
        $.ajax({
            type: "POST", // or GET if your API is GET, change if needed
            url: "/api/MatterApi/IOCLGrahDatastatusList",
            contentType: false,
            processData: false,
            success: function (response) {
                // expecting something like { Data: "[{ \"CourtName\":\"SUPREME COURT\"}, ...]" }
    ...
    function LoadAdvocateDropdown() {
        ...
        $.ajax({
            type: "POST", // or GET if your API is GET, change if needed
            url: "/api/MatterApi/IOCLGrahDataAdvocateList",
            contentType: false,
            processData: false,
            success: function (response) {
                if (!response || !response.Data) {
    ...
    function SearchFilterData() {
        ...
        var filterAmount = $("#AmountOver10L").val();
        var filterClaim = $("#ClaimByAgainst").val();
        GetChartData(filterCourtName, filterStatus, filterDepartment, filterAdvocate, filterAmount, filterClaim);
    }
    ...
    function GetChartData(filterCourtName, filterStatus, filterDepartment, filterAdvocate, filterAmount, filterClaim) {
            $('#myOverlayDashboard').show();
        courtWiseData(filterCourtName, filterStatus, filterDepartment, filterAdvocate, filterAmount, filterClaim);
        StatusWiseData(filterCourtName, filterStatus, filterDepartment, filterAdvocate, filterAmount, filterClaim);
        TotalcountData(filterCourtName, filterStatus, filterDepartment, filterAdvocate, filterAmount, filterClaim);
        AdvocateWiseStatusData(filterCourtName, filterStatus, filterDepartment, filterAdvocate, filterAmount, filterClaim);
        LoadStatusSummary(filterCourtName, filterStatus, filterDepartment, filterAdvocate, filterAmount, filterClaim);
        DepartmentWiseData(filterCourtName, filterStatus, filterDepartment, filterAdvocate, filterAmount, filterClaim);
        //AmountWiseData(filterCourtName, filterStatus, filterDepartment, filterAdvocate, filterAmount, filterClaim);
        //ClaimWiseData(filterCourtName, filterStatus, filterDepartment, filterAdvocate, filterAmount, filterClaim);
    }
    ...
    function courtWiseData(filterCourtName, filterStatus, filterDepartment, filterAdvocate) {
        ...
        $.ajax({
            type: "POST",
            url: "/api/MatterApi/IOCLGrahDataCourtWise", // this should call proc that returns court-wise data
            data: formData,
            contentType: false,
            processData: false,
    ...
    function StatusWiseData(filterCourtName, filterStatus, filterDepartment, filterAdvocate) {
        ...
        $.ajax({
            type: "POST",
            url: "/api/MatterApi/IOCLGrahDataStatusWise", // should return status-wise data
            data: formData,
            contentType: false,
            processData: false,
            success: function (response1) {
    ...
    function TotalcountData(filterCourtName, filterStatus, filterDepartment, filterAdvocate) {
        ...
        $.ajax({
            type: "POST",
            url: "/api/MatterApi/IOCLGrahDataTotalCount",
            data: formData,
            contentType: false,
            processData: false,
            success: function (response1) {
    ...
    function AdvocateWiseStatusData(filterCourtName, filterStatus, filterDepartment, filterAdvocate) {
        ...
        $.ajax({
            type: "POST",
            url: "/api/MatterApi/IOCLGrahDataAdvocateWiseStatusData",
            data: formData,
            contentType: false,
            processData: false,
            success: function (response1) {
    ...
    function LoadStatusSummary(filterCourtName, filterStatus, filterDepartment, filterAdvocate) {
        ...
        $.ajax({
            type: "POST",
            url: "/api/MatterApi/IOCLGrahDataStatusData",
            data: formData,
            contentType: false,
            processData: false,
            success: function (response1) {
    ...
    function DepartmentWiseData(filterCourtName, filterStatus, filterDepartment, filterAdvocate) {
        ...
        $.ajax({
            type: "POST",
            url: "/api/MatterApi/IOCLGrahDataDepartmentData",
            data: formData,
            contentType: false,
            processData: false,
            success: function (response1) {
