            ...
            success: function (data) {
                ...
                $.each(data, function (i, a) {
                    ...
                    if (a.FileFolder == false) {
                        ...
                        html += '</td> <td><a href="javascript:void()" title="Remove document" style="color:red" code="' + a.srcPath + '" id="DeleteFile" dpath="' + a.destinationPath + '"><span class="glyphicon glyphicon-trash"></span></a> &nbsp;&nbsp;<a href="/' + fcode + '/azure/DownloadFile/?status=true&filename=' + a.blobName + '&code=' + a.srcPath + '" target="_blank" title="Download document" style="color:green"  id="DownloadFile" ><span class="glyphicon glyphicon-download"></span></a>&nbsp;&nbsp;&nbsp;<span id="savedropbox" href="' + a.blobName + '" code="' + a.srcPath + '" class="glyphicon glyphicon-cloud-upload" style="color: #1da1ce;font-size:15px;cursor:pointer" title="Upload document to Cloud Server(Dropbox/Google Drive)"></span>&nbsp;&nbsp;&nbsp;<btn class="btn btn-warning btn-sm" style="margin-top:0px;" title="Share document to users." data-toggle="modal" id="permopen" value="' + a.srcPath + '" valuename="' + a.blobName + '"></span> Share</btn></td > <td>' + ftype + ' File</td></tr >';
                    }
                });
