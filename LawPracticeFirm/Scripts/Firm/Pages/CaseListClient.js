$(document).ready(function () {
    ...
    $(document).on("click", "#exporttoexcelfile", function () {
        ...
        var Filed_By_Againstfilter=$('#Filed_By_Againstfilter').val();
        var Favour_Againstfilter=$('#Favour_Againstfilter').val();
        var DeptType_filter=$('#DeptType_Againstfilter').val();
        ...
        url_redirect({
            ...
            data: {
                ...
                "Filed_By_Againstfilter": EncodeText(Filed_By_Againstfilter), "Favour_Againstfilter": EncodeText(Favour_Againstfilter),
                "DeptType_filter": EncodeText(DeptType_filter)
            }
        });
    })
    ...
    $(document).on("click", "#exporttopdffile", function () {
        ...
        url_redirect({
            ...
            data: {
                ...
                "FiledByFiler": EncodeText(Filed_By_Againstfilter), "FavourAgainstFilter": EncodeText(Favour_Againstfilter)
            }
        });
    ...
    $("#Filed_By_Againstfilter").change(function () {
        loadflag = true;
        isRenderPage = false;
        loadcontactlist(1, "", "");
        chksflag = true;
    });
    $("#Favour_Againstfilter").change(function () {
        loadflag = true;
        isRenderPage = false;
        loadcontactlist(1, "", "");
        chksflag = true;
    ...
    function loadcontactlist(pageindex, searchcolnaame, searchcolvalue) {
        ...
        var deptType = $('#DeptType_Againstfilter').val();
        var departName = "";
        if (deptType == '01') {
            departName = "LAD";
        } else if (deptType == '02') {
        ...
        formdata.append("Filed_By_Againstfilter", EncodeText($('#Filed_By_Againstfilter').val()));
        formdata.append("Favour_Againstfilter", EncodeText($('#Favour_Againstfilter').val()));
        //formdata.append("DeptType_filter", EncodeText($('#DeptType_Againstfilter').val()));
        formdata.append("DeptType_filter", EncodeText(departName));
            ...
            success: function (response) {
                ...
                if (loadflag == true) {
                    $.each(obj, function (i, val) {
                        ...
                        $row.append($('<td class="Case_Nomenclature"  />').html("<span name='" + val.case_Nomenclature + "'> " + (val.case_Nomenclature != null ? val.case_Nomenclature : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="Name_City"  />').html("<span name='" + val.Name_City + "'> " + (val.Name_City != null ? val.Name_City : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="Name_State"  />').html("<span name='" + val.Name_State + "'> " + (val.Name_State != null ? val.Name_State : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="Filed_By_Against"  />').html("<span name='" + val.FiledBy + "'> " + (val.FiledBy != null ? val.FiledBy + "</span>" : '<span style="visibility: hidden;">&nbsp;</span>') + (isdiarygreen == 1 ? "<a href='javascript:void(0)' mattername='" + val.mname + "' mastercaseid=" + val.MasterCaseId + " title='SEBI- Edit Filed By / Against' id=EditFiledBy><i class='glyphicon glyphicon-edit'></i></a>" : "")));
                        $row.append($('<td class="ActionStatus"  />').html("<span name='Favour_Against'>" + (val.ActionStatus == null ? "" : val.ActionStatus) + "" + (isdiarygreen == 1 ? " &nbsp;<a href='javascript:void(0)' mattername='" + val.mname + "' mastercaseid=" + val.Id + " usercaseid=" + val.UserCaseid + " title='SEBI- Edit Favour / Against' id=EditFavour><i class='glyphicon glyphicon-edit'></i></a>" : "") + "</span>"));
                        //For Department Type Settings
                        $row.append($('<td class="DeptActionStatus"  />').html("<span name='DeptType_Againstfilter'>" + (val.DepartType == null ? "" : val.DepartType) + " <a href='javascript:void(0)' mattername='" + val.mname + "' mastercaseid=" + val.Id + " usercaseid=" + val.UserCaseid + " title='Department Type' id=EditDeptType><i class='glyphicon glyphicon-edit'></i></a>" + "</span>"));
                        $row.append($('<td class="ULNno"  />').html("<span name='" + val.ULN + "'> " + (val.ULN != null ? val.ULN : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="NatureOfCase"  />').html("<span name='" + val.NatureOfCase + "'> " + (val.NatureOfCase != null ? val.NatureOfCase : '<span style="visibility: hidden;">&nbsp;</span>')));
                        // $row.append($('<td class="MatterType"  />').html("<span name='" + val.SebiMatterType + "'> " + (val.SebiMatterType != null ? val.SebiMatterType : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="MatterOf"  />').html("<span name='" + val.MatterOf + "'> " + (val.MatterOf != null ? val.MatterOf : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="BriefOfMatter"  />').html("<span name='" + val.BriefOfMatter + "'> " + (val.BriefOfMatter != null ? val.BriefOfMatter : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="Relevance"  />').html("<span name='" + val.Relevance + "'> " + (val.Relevance != null ? val.Relevance : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="IssuesInvolved"  />').html("<span name='" + val.IssuesInvolved + "'> " + (val.IssuesInvolved != null ? val.SebiMatterType : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="NatureOfViolation"  />').html("<span name='" + val.NatureOfViolation + "'> " + (val.NatureOfViolation != null ? val.NatureOfViolation : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="Casecategory"  />').html("<span name='" + val.Casecategory + "'> " + (val.Casecategory != null ? val.Casecategory : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="DateOfImpugned"  />').html("<span name='" + val.DateOfImpugned + "'> " + (val.DateOfImpugned != null ? val.DateOfImpugned : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="IssuingAuthority"  />').html("<span name='" + val.IssuingAuthority + "'> " + (val.IssuingAuthority != null ? val.IssuingAuthority : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="DirectionUnderTheOrder"  />').html("<span name='" + val.DirectionUnderTheOrder + "'> " + (val.DirectionUnderTheOrder != null ? val.DirectionUnderTheOrder : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="ReplyField"  />').html("<span name='" + val.ReplyField + "'> " + (val.ReplyField != null ? val.ReplyField : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="MatterStage"  />').html("<span name='" + val.MatterStage + "'> " + (val.MatterStage != null ? val.MatterStage : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="StayOrder"  />').html("<span name='" + val.StayOrder + "'> " + (val.StayOrder != null ? val.StayOrder : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="DateOfStayOrder"  />').html("<span name='" + val.DateOfStayOrder + "'> " + (val.DateOfStayOrder != null ? val.DateOfStayOrder : '<span style="visibility: hidden;">&nbsp;</span>')));

                        $row.append($('<td class="NameOfParty"  />').html("<span name='" + val.NameOfParty + "'> " + (val.NameOfParty != null ? val.NameOfParty : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="DateTill"  />').html("<span name='" + val.DateTill + "'> " + (val.DateTill != null ? val.DateTill : '<span style="visibility: hidden;">&nbsp;</span>')));

                        $row.append($('<td class="ExtendedTill"  />').html("<span name='" + val.ExtendedTill + "'> " + (val.ExtendedTill != null ? val.ExtendedTill : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="StayVacatedOn"  />').html("<span name='" + val.StayVacatedOn + "'> " + (val.StayVacatedOn != null ? val.StayVacatedOn : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="DirectionOfCourt"  />').html("<span name='" + val.DirectionOfCourt + "'> " + (val.DirectionOfCourt != null ? val.DirectionOfCourt : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="ExpactedDateOfCompliance"  />').html("<span name='" + val.ExpactedDateOfCompliance + "'> " + (val.ExpactedDateOfCompliance != null ? val.ExpactedDateOfCompliance : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="OprationDepartmentInchargeOFCompliance"  />').html("<span name='" + val.OprationDepartmentInchargeOFCompliance + "'> " + (val.OprationDepartmentInchargeOFCompliance != null ? val.OprationDepartmentInchargeOFCompliance : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="DateOfCompliance"  />').html("<span name='" + val.DateOfCompliance + "'> " + (val.DateOfCompliance != null ? val.DateOfCompliance : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="DisposalInFavour"  />').html("<span name='" + val.DisposalInFavour + "'> " + (val.DisposalInFavour != null ? val.DisposalInFavour : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="NatureOfDisposal"  />').html("<span name='" + val.NatureOfDisposal + "'> " + (val.NatureOfDisposal != null ? val.NatureOfDisposal : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="OperationDepartmentForThePurposeOfSeeking"  />').html("<span name='" + val.OperationDepartmentForThePurposeOfSeeking + "'> " + (val.OperationDepartmentForThePurposeOfSeeking != null ? val.OperationDepartmentForThePurposeOfSeeking : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="NameOfTheDealingOfficer"  />').html("<span name='" + val.NameOfTheDealingOfficer + "'> " + (val.NameOfTheDealingOfficer != null ? val.NameOfTheDealingOfficer : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="NameOfOfficer"  />').html("<span name='" + val.NameOfOfficer + "'> " + (val.NameOfOfficer != null ? val.NameOfOfficer : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="ProformaParty"  />').html("<span name='" + val.ProformaParty + "'> " + (val.ProformaParty != null ? val.ProformaParty : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="MarketActivity"  />').html("<span name='" + val.MarketActivity + "'> " + (val.MarketActivity != null ? val.MarketActivity : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="GovernmentAuthorityParty"  />').html("<span name='" + val.GovernmentAuthorityParty + "'> " + (val.GovernmentAuthorityParty != null ? val.GovernmentAuthorityParty : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="CourtOrders"  />').html("<span name='" + val.courtorder + "'> " + (val.courtorder != null ? val.courtorder : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="Solicitors"  />').html("<span name='" + val.solicitor + "'> " + (val.solicitor != null ? val.solicitor : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="Details_Of_Bench"  />').html("<span name='" + val.CourtComplex + "'> " + (val.CourtComplex != null ? val.CourtComplex : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="Connected_Matters"  />').html("<span name='" + val.connectedmtr + "'> " + (val.connectedmtr != null ? val.connectedmtr : '<span style="visibility: hidden;">&nbsp;</span>')));
                        $row.append($('<td class="Remarks"  />').html("<span name='" + val.Remarks + "'> " + (val.Remarks != null ? val.Remarks : '<span style="visibility: hidden;">&nbsp;</span>')));
    ...
    $(document).on("click", "#EditFiledBy", function () {
        var obj = $(this);
        $("#ddlFiledBy").val("");
        $("#Filedmattername").html($(obj).attr("mattername"));
        $("#hdnFiledcaseid").val($(obj).attr("mastercaseid"));
        var OldAction = $(obj).closest("td").text().replace(/^\s+|\s+$/g, "");
        if (OldAction != "")
            $("#ddlFiledBy").val(OldAction)
        $("#FiledByModal").modal("show");
    })
    $(document).on("click", "#updateFiledBy", function () {

        var matterid = $("#hdnFiledcaseid").val();
        var FiledByStatus = $('#ddlFiledBy').val();
        if (FiledByStatus == "" || FiledByStatus == null) {
            alert("Select Filed By/ Against By");
            return false;
        }
        var formData = new FormData();
        formData.append("matterid", matterid);
        formData.append("FiledByStatus", FiledByStatus);
        $.ajax(
            {
                type: "POST",
                url: "/api/MatterApi/CWUpdateFiledByStatus",
                data: formData,
                contentType: false,
                processData: false,
                success: function (response) {
                    if (response.Status) {
                        ...
                        $("#FiledByModal").modal("hide");
                        loadflag = true;
                        loadcontactlist($("#pgetdatabypagenum").attr("pageindex"), "", "");
                    } else {
    ...
    $(document).on("click", "#EditFavour", function () {
        var obj = $(this);
        $("#favmattername").html($(obj).attr("mattername"));
        $("#hdnfavmastercaseid").val($(obj).attr("mastercaseid"));
        $("#hdnfavusercaseid").val($(obj).attr("usercaseid"));
        SelectFavourAgainst();
    })
    $(document).on("click", "#EditDeptType", function () {
        var obj = $(this);
        $("#favmattername").html($(obj).attr("mattername"));
        $("#hdnfavmastercaseid").val($(obj).attr("mastercaseid"));
        $("#hdnfavusercaseid").val($(obj).attr("usercaseid"));
    ...
    $(document).on("click", "#updateDeptTypebtn", function () {
        var matterid = $("#hdnfavmastercaseid").val();
        var usercaseid = $("#hdnfavusercaseid").val();
        var DepartmentType = $('#ddlDeptType').val(); 
        var Departmenttypetext = $("#ddlDeptType option:selected").text();
        ...
        formData.append("DepartmentTypeText", Departmenttypetext);
        
        $.ajax(
            {
                type: "POST",
                url: "/api/MatterApi/UpdateDepartmentType",
                data: formData,
                contentType: false,
                processData: false,
                success: function (response) {
    ...
    $("#DeptType_Againstfilter").change(function () {
        loadflag = true;
        loadcontactlist(1, "", "");
        chksflag = true;
    });

    $(document).on("click", "#updatefavouragaint", function () {
        var matterid = $("#hdnfavmastercaseid").val();
        var usercaseid = $("#hdnfavusercaseid").val();
        var ActionStatus = $('#ddlFavourAgaint').val();
        if (ActionStatus == "" || ActionStatus == null) {
            alert("Select FAVOUR/ AGAINST");
            return false;
        }
        var formData = new FormData();
        formData.append("matterid", matterid);
        ...
        $.ajax(
            {
                type: "POST",
                url: "/api/MatterApi/Updatefavouragaint",
                data: formData,
                contentType: false,
                processData: false,
                success: function (response) {
    ...
    function SelectFavourAgainst() {
        ...
        $.ajax(
            {
                type: "POST",
                url: "/api/MatterApi/BindSEBIFavourAgainstbycaseid",
                data: formData,
                contentType: false,
                processData: false,
                success: function (response) {
                    if (response.Status) {
                        var favour = response.Data.Data;
                        $("#ddlFavourAgaint").val(favour);
                    } else {
                        $("#ddlFavourAgaint").val("");
                    }
...
//    var MatterType = $("#MatterTypeInforce").val();
