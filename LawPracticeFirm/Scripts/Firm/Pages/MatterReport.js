...
$(document).ready(function () {
  ...
  //Reset Form 
    $("#MtrClearReport").click(function () {
        $('#idreportformat')[0].reset();
        isRenderPage = false;
        LoadMatterData(1)
    });
    /*Export excel*/
    ...
    <ul class="table_action">
        <li>
            <span class="taskoutboxbtnicon download-excel" id="oexcelexport" pageno="${i}" type="excel" title="Download File">
...
/*Download in pdf*/
    ...
    <td>
        <ul class="table_action">
            <li>
                <span class="taskoutboxbtnicon" id="opdfexport" pageno="${i}" type="excel" title="Download File">
                   <img src="/newassets/img/download.svg" />
                </span>
            </li>
        </ul>
