        ...
        var j1 = $.ajax({
            ...
            success: function (response1) {
                ...
                $.each(obj, function (i, a) {
                    ...
                    togsum = togsum + 1;
                    html += '<tr><td class="7"><span class="glyphicon glyphicon-folder-open" aria-hidden="true" style="color:orange"> </span>&nbsp;&nbsp;<a href="/' + fcode + '/Firm/ShareUserFileList/' + a.DirId + ' " style="color: black"><span>' + dirname + '<span></a></td><td width="100px; ">' + dates1 + '</td></td><td>' + a.shareby + '</td></tr>';
                });
