$(document).ready(function () {
    ...
    /*Link to create compose message*/
    $("#composemessage").click(function () {
        window.location = "/" + fcode + "/client/composemessage";
    });
    /*Link to select all message list*/
