$(document).ready(function () {
    ...
    /*Get all matter detail on client change*/
    ...
    /*Mark document as confidentials*/
    ...
    $("#DigiFileSaves").click(function () {
        ...
        window.location.href = "/Azure/GetSigncopy";
    });
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.each(obj, function (i, a) {
                    ...
                    //    }
                    //    else {
                    //        html6 += '<td><span style="color:#069; cursor:pointer" title="Download File" download="' + a.fname + '" id="downloadfile" href-val="' + downloadpath + '" href="javascript:void();" values="' + a.Id + '">' + filename + ' (Version - ' + ct + ')</span></td>';
                    //    }
                    //}
                    //else {
                    //    html6 += '<td><span style="color:#069; cursor:pointer" title="Download File" download="' + a.fname + '" id="downloadfile" href-val="' + downloadpath + '" href="javascript:void();" values="' + a.Id + '">' + filename + ' (Version - ' + ct + ')</span></td>';
    ...
    $(document).on("click", "#movefile", function () {
        ...
        if (selectedID != "") {
            ...
            new PNotify({
                title: 'Warning',
                text: ' You do not have selected any document?',
                type: 'error',
                delay: 3000
            });
            closeload();
    ...
    /*load contact based on user type*/
    ...
    /*Search data for load directory details*/
    ...
    /*Load Directory Files by page index and search type*/
    var dirtoken = "";
    function LoadDirectoryFiles(pageindex, searchtype) {
        ...
        var rt1 = $.ajax({
            async: true,
            url: '/api/AzureApi/UserDirectoryList1byCheckOutrowid',//UserDirectoryList1byrowid
            data: formData,
            contentType: false,
            processData: false,
            type: 'POST',
                    ...
                    $.each(obj, function (i, a) {
                        ...
                        if (a.ftype == 1) {
                            ...
                            if (a.odelete == 1 || roleid == 1) {
                                ...
                                html += '<div class="file_wrapper"><img width="32px" height="32px" name = "' + a.fname + '" src="/newassets/img/' + ficon + '" style = "font-size:14px;color:' + icolor + '" /> <span id-val="' + a.oedit + '" id-checkout="' + a.IsCheckinOut + '" downloadpath1="' + downloadpath + '" style="cursor:pointer" code="' + a.AZureFileId + '" id="idss" value="' + last + '" href="' + openurl + '" urltype="' + urlstype + '"> ' + a.fname + '</span></a >'
                                ...
                                html += '<td style="' + rowreflect + '">'
                                if (String(a.CheckoutUser).toLowerCase() == String(userid).toLowerCase()) {
                                    if (a.oedit == "1") {
                                        if (a.IsCheckinOut == "1") {
                                            html += '<span style="' + chkincss + '" class="checkin1 checkin' + a.id + '" title="Upload the new version of file post edit" fname="' + a.fname + '" id="checkin" value="' + a.id + '">Checkin <img src="/newassets/img/right_arrow.svg"></span></td>';
                                        }
                                        else {
                                            html += '<span style="cursor:pointer;' + chkoutcss + '" href-val="' + checkoutpath + '" title="Download the file for OFFLINE Editing" class="checkout checkout' + a.id + '" id="checkout" value="' + a.id + '">Check Out <img src="/newassets/img/right_arrow.svg"></span></td>';
                                        }
                                    }
                                }
                                else {
                                    if (a.oedit == "1") {
                                        if (a.IsCheckinOut == "1") {
                                            html += '<span class="inuse" style="' + chkincss + '" id="InUse' + a.id + '"  isinuse="1" title=" File In Use for editing  by ' + a.CheckoutUserName + '" >In Use</span></td>';
                                        }
                                        else {
                                            html += '<span style="cursor:pointer;' + chkoutcss + '" href-val="' + checkoutpath + '" title="Download the file for OFFLINE Editing" class="checkout checkout' + a.id + '" id="checkout" value="' + a.id + '">Check Out <img src="/newassets/img/right_arrow.svg"></span></td>';
                                        }
                                ...
                                html += '<ul class="table_action" style="justify-content:center;"> <li> <span class="taskoutboxbtnicon"><a title="Download Original Version" download="' + a.fname + '" id="downloadfile" href-val="' + downloadpath + '" href="javascript:void();" values="' + a.id + '"> <img src="/newassets/img/download.svg" /></a> </span> </li>'
                                html += '<li><span class="taskoutboxbtnicon" title="Click here to view document version" checkinouttab="' + a.IsCheckinOut + '" id="viewfileversion" token="' + a.id + '" filename="' + a.fname + '" class="btn-viewdv dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="height: 26px;"><img src="/newassets/img/versionHi.png"/></span></li></ul>'
                                html += '</td>'

                                //**************
                                //html += '<table width="100%" class="docactiontable" style="border-collapse: separate"><tr>';
                                //html += '<td  style="padding: 5px 0 0 0 !important;margin: 0;' + rowreflect + '"></td>';

                                //html += '<td  width="20px" style="' + rowreflect + '"><a class="glyphicon glyphicon-download-alt" style="color:#0059c1; cursor: pointer; border:1px solid black; border-radius: 50%; padding: 3px; font-size: 10px;" title="Download Original Version" download="' + a.fname + '" id="downloadfile" href-val="' + downloadpath + '" href="javascript:void();" values="' + a.id + '"> </a> </span ></td>';
                                //html += '<td  style="padding: 5px 0 0 0 !important;margin: 0;' + rowreflect + '"></td>';
                                //***************
                                //if (String(a.CheckoutUser).toLowerCase() == String(userid).toLowerCase()) {
                                //    if (a.oedit == "1") {
                                //        if (a.IsCheckinOut == "1") {
                                //            html += '<td style="' + rowreflect + '"><span style="cursor:pointer;color:#069;' + chkincss + '" class="checkin' + a.id + '" title="Upload the new version of file post edit" fname="' + a.fname + '" id="checkin" value="' + a.id + '">Checkin</span></td>';
                                //        }
                                //        else {
                                //            html += '<td style="' + rowreflect + '"><span style="cursor:pointer;color:maroon;' + chkoutcss + '" href-val="' + checkoutpath + '" title="Download the file for OFFLINE Editing" class="checkout' + a.id + '" id="checkout" value="' + a.id + '">Check Out</span></td>';
                                //        }
                                //    }
                                //}
                                //else {
                                //    if (a.oedit == "1") {
                                //        if (a.IsCheckinOut == "1") {
                                //            html += '<td style="' + rowreflect + '"><span style="' + chkincss + '" id="InUse' + a.id + '"  isinuse="1" title=" File In Use for editing  by ' + a.CheckoutUserName + '" >In Use</span></td>';
                                //        }
                                //        else {
                                //            html += '<td style="' + rowreflect + '"><span style="cursor:pointer;color:maroon;' + chkoutcss + '" href-val="' + checkoutpath + '" title="Download the file for OFFLINE Editing" class="checkout' + a.id + '" id="checkout" value="' + a.id + '">Check Out</span></td>';
                                //        }
                                ...
                                html += '<td style="' + rowreflect + '">' + last + '</td>';
                                html += '<td style="' + rowreflect + '">' + (a.FileSize != null ? a.FileSize : "") + '</td><td style="' + rowreflect + '">' + a.CreatedBy + '</td>';
                                ...
                                if (String(a.CheckoutUser).toLowerCase() == String(userid).toLowerCase()) {
                                    if (a.oedit == "1") {
                                        if (a.IsCheckinOut == "1") {
                                            html += '<td style="' + rowreflect + '"><span style="cursor:pointer;color:#069;' + chkincss + '" class="checkin1 checkin' + a.id + '" title="Upload the new version of file post edit" fname="' + a.fname + '" id="checkin" value="' + a.id + '">Checkin <img src="/newassets/img/right_arrow.svg"></span></td>';
                                        }
                                        else {
                                            html += '<td> style="' + rowreflect + '"<span style="cursor:pointer;' + chkoutcss + '" href-val="' + checkoutpath + '" title="Download the file for OFFLINE Editing" class="checkout checkout' + a.id + '" id="checkout" value="' + a.id + '">Check Out</span></td>';
                                        }
                                    }
                                }
                                else {
                                    if (a.oedit == "1") {
                                        if (a.IsCheckinOut == "1") {
                                            ...
                                            html += '<td style="' + rowreflect + '"><span style="cursor:pointer;' + chkoutcss + '" href-val="' + checkoutpath + '" title="Download the file for OFFLINE Editing" class="checkout checkout' + a.id + '" id="checkout" value="' + a.id + '">Check Out <img src="/newassets/img/right_arrow.svg"></span></td>';
                                        }
                                    }
                                }
                                html += '</td>'
                                ...
                                html += '<table width="100%" class="docactiontable" style="border-collapse: separate"><tr>';
                                html += '<td style="' + rowreflect + ';padding:0px !important">';
                                html += '<td width="20px" style="' + rowreflect + '"><a class="glyphicon glyphicon-download-alt" style="color:#0059c1; cursor: pointer; border:1px solid #0059c1; border-radius: 50%; padding: 3px; font-size: 10px;" title="Download Original Version" download="' + a.fname + '" id="downloadfile" href-val="' + downloadpath + '" href="javascript:void();" values="' + a.id + '"> </a> </span ></td>';
                                html += '<td style="' + rowreflect + ';padding:0px !important">';
                                //if (String(a.CheckoutUser).toLowerCase() == String(userid).toLowerCase()) {
                                //    if (a.oedit == "1") {
                                //        if (a.IsCheckinOut == "1") {
                                ...
                                if (a.share == 1) {
                                    html += '<td style="' + rowreflect + '">' + last + '</td>'
                                    html += '<td style="' + rowreflect + '">' + a.FileSize + '</td> <td style="' + rowreflect + '">' + a.CreatedBy + '</td>';
                                    html += ' <td style="' + rowreflect + '">' + ((a.fdetails == null || a.fdetails == "NULL") ? "" : a.fdetails) + '</td>';
                                    html += ' </tr> ';
                                }
                                else {
                                    ...
                                    html += ' <td style="' + rowreflect + '">' + ((a.fdetails == null || a.fdetails == "NULL") ? "" : a.fdetails) + '</td> <td style="' + rowreflect + '">' + a.CaseNames + '</td>';
                                    html += '</tr > ';
                                }
                            }
                            else {
                                ...
                                if (String(a.CheckoutUser).toLowerCase() == String(userid).toLowerCase()) {
                                    if (a.oedit == "1") {
                                        if (a.IsCheckinOut == "1") {
                                            ...
                                            html += '<td><span style="cursor:pointer;' + chkoutcss + '" href-val="' + checkoutpath + '" title="Download the file for OFFLINE Editing" class="checkout checkout' + a.id + '" id="checkout" value="' + a.id + '">Check Out<img src="/newassets/img/right_arrow.svg"></span></td>';
                                        }
                                    }
                                }
                                else {
                                ...
                                html += '<td width="100px;" style="' + rowreflect + '">' + dates1 + '</td>';
                                html += '<td style="' + rowreflect + ';padding:0px !important">';
                                html += '<table class="docactiontable" style="border-collapse: separate"><tr><td></td>';
                                html += '<td width="20px" style="' + rowreflect + '"><a class="glyphicon glyphicon-download-alt" style="color:#0059c1; cursor: pointer; border:1px solid #0059c1; border-radius: 50%; padding: 3px; font-size: 10px;" title="Download Original Version" download="' + a.fname + '" id="downloadfile" href-val="' + downloadpath + '" href="javascript:void();" values="' + a.id + '"> </a> </span ></td>';
                                html += '<td style="' + rowreflect + ';padding:0px !important">';
                                //if (String(a.CheckoutUser).toLowerCase() == String(userid).toLowerCase()) {
                                //    if (a.oedit == "1") {
                                ...
                                if (a.share == 1) {
                                    ...
                                    html += '<td style="' + rowreflect + '">' + last + '</td>';
                                    html += '<td style="' + rowreflect + '" name="' + a.CreatedBy + '">' + a.CreatedBy + '</td> <td style="' + rowreflect + '">' + ((a.fdetails == null || a.fdetails == "NULL") ? "" : a.fdetails) + '</td> </tr > ';
                                }
                            }
                        }
                        else {
                            ...
                            if (a.odelete == 1 && roleid == 1) {
                                ...
                                html += '<tr><td><input type="checkbox" fpath-val="" data-val="' + a.id + '" data-flag="-1"  fname-val="' + a.fname + '" class="checkbox"/></td><td class="7"><div class="file_wrapper" name="' + a.fname + '" aria-hidden="true" > <img height="32px" width="32px" src="/newassets/img/file_blue.svg"><a id="transferpage" caseid="' + caseidsnew + '" href="javascript:void()" data-val="' + a.id + '" style="color: black"><span>' + ViewFolderName + '<span></a> <i class="' + dsyncicon + ' pull-right" title="' + dsynctitle + '"></i> </div> </td><td width="100px; ">' + dates1 + '</span ></td>';
                                html += '<td></td><td style="padding:0px !important"><ul class="table_action"><li><span class="taskoutboxbtnicon" id="removedir" code="' + a.AZureFileId + '" values="' + a.id + '" dirname="' + a.fname + '" filepath="' + directorypath + '" ><img src="/newassets/img/delete.svg" /></span>';
                                
                                if (a.ChildFolderCount == 0 && a.Caseid == "") {
                                ...
                                html += '</ul></td > ';
                                html += '<td></td>';
                                html += '<td>&nbsp;</td> <td>' + a.CreatedBy + '</td> <td></td></tr > ';
                            }
                            else if (a.odelete == 1 || roleid == 1) {
                                html += '<tr><td><input type="checkbox" fpath-val="" data-val="' + a.id + '" data-flag="-1"  fname-val="' + a.fname + '" class="checkbox"/></td><td class="7"><div class="file_wrapper" name="' + a.fname + '" aria-hidden="true"> <img height="32px" width="32px" src="/newassets/img/file_blue.svg"> <a id="transferpage" caseid="' + caseidsnew + '" href="javascript:void()" data-val="' + a.id + '" style="color: black"><span>' + ViewFolderName + '<span></a> <i class="' + dsyncicon + ' pull-right" title="' + dsynctitle + '"></i></div>  </td><td width="100px; ">' + dates1 + '</td>';
                                html += '<td style="padding:0px !important"><ul><li><span class="taskoutboxbtnicon" id="removedir" code="' + a.AZureFileId + '" values="' + a.id + '" dirname="' + a.fname + '" filepath="' + directorypath + '" ><img src="/newassets/img/delete.svg" /> </span></li>';
                                if (a.ChildFolderCount == 0 && a.Caseid == "") {
                                    html += '<li><span class="taskoutboxbtnicon" id="renameDir" title="Rename Folder" values="' + a.id + '" dirname="' + a.fname + '"> <img src="/newassets/img/edit.svg"> </span> </li>'
                                    html += '<li><span class="taskoutboxbtnicon" id="moveDir" title="Move Folder" values="' + a.id + '" dirname="' + a.fname + '"><img src="/newassets/img/moveFolder.svg"> </span> </li>'
                                }
                                ...
                                html += '<tr><td><input type="checkbox" fpath-val="" data-val="' + a.id + '" data-flag="-1"  fname-val="' + a.fname + '" class="checkbox"/></td><td class="7"><div class="file_wrapper" name="' + a.fname + '" aria-hidden="true"> <a id="transferpage"  caseid="' + caseidsnew + '" href="javascript:void()" data-val="' + a.id + '" style="color: black"><span>' + ViewFolderName + '<span></a> <i class="' + dsyncicon + ' pull-right" title="' + dsynctitle + '"></i></div></td><td width="100px; ">' + dates1 + '</td>';
                                if (a.ChildFolderCount == 0 && a.Caseid == "") {
                                    html += '<td> <ul><li><span class="taskoutboxbtnicon" id="renameDir" title="Rename Folder" values="' + a.id + '" dirname="' + a.fname + '"> <img src="/newassets/img/edit.svg">  </span></li>'
                                    html += '<li><span class="taskoutboxbtnicon" id="moveDir" title="Move Folder" values="' + a.id + '" dirname="' + a.fname + '"><img src="/newassets/img/moveFolder.svg"> </span></li></ul></td>'
                                }
                                else {
                                    html += '<td></td>'
                                }
    ...
    //    isCommPopRnd = true;
    //    LoadDirectoryFiles(goToPage, searchtype);
    //    $(".page-btncommPop").removeClass("active");
    //    $(".page-btncommPop[data-page='" + goToPage + "']").addClass("active");
    //});
