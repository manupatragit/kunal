    ...
    $.ajax({
        ...
        success: function (response1) {
            ...
            if (!res.Status) {
                ...
                var strhtml = '<div style="width: 100%;">' + reportdata + '<table style="width:60%;margin:auto;border-collapse: separate;border-spacing: 0;" class="printtbl"><tr><th>State</th><th>No.of cases filed by SEBI</th><th>No. of cases filed against SEBI</th></tr>';
                $.each(res, function (i) {
                    if (i < res.length-1)
