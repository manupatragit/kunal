    ...
    $.ajax({
        ...
        success: function (response1) {
            ...
            if (!res.Status) {
                ...
                strhtml += '<ul style="list-style:auto"><li><strong>Super Active Cases :</strong> Cases listed or action taken by IOCL since in the past 12 months.</li>'
                strhtml += '<li><strong>Active Cases :</strong> Cases listed or action taken by IOCL in more than 12 but less than 24 months.</li>'
