...
; (function ($) {
    ...
    var default_opts = {
        ...
        maxfilesize: 20,         // MB file size limit
        ...
        error: function (err, file, i, status) {
            alert(err);
            if (err == "File size is too Large") {
                var urls = "/" + fcode + "/PDFMerge/PDFMerge";
                url_redirect({
                    url: urls,
                    method: "post"
                });
        ...
        errors = ["Browser Not Supported", "Too Many Files", "File size is too Large", "File Type Not Allowed", "Not Found", "Not Readable", "Abort Error", "Read Error", "File Extension is Not Allowed"];
