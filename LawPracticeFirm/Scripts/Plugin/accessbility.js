...
$(document).ready(function () {
    ...
    $('#incfont').click(function () {
        ...
        modifyFontSize('increase', 0.02,0.005);

    });

    $('#decfont').click(function () {
        modifyFontSize('decrease', -0.02, -0.005);
    });
    ...
    zoomLevel = 1;
    zoomLevelmoz = 1;
    function modifyFontSize(flag, zoom,zoommoz) {
        ...
        if (flag == 'increase') {
            ...
            if (clickcountin < 3) {
                ...
                zoomLevel += zoom;
                zoomLevelmoz += zoommoz;
                
                $('body').css({ zoom: zoomLevel, '-moz-transform': 'scale(' + zoomLevelmoz + ')' });
