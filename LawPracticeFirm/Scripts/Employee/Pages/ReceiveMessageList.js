                ...
                try {
                    $.each(obj, function (i, val) {
                        ...
                        var $row1 = '<div data-type="accordion-section" id="maindiv' + val.mid + '" class="search" style="cursor: pointer;border-left: 1px solid gray;border-right: 1px solid gray;border-bottom: 1px solid lightgray; overflow:hidden;margin:0 0 5px 0;" >' +
                            ...
                            //'<input type="button" id="savereplyAll" idval="' + val.mid + '" userval="' + val.userid + '" class="btn save ash' + val.mid + '" value="Send All">&nbsp;&nbsp;&nbsp;<input type="button" id="savereply" idval="' + val.mid + '" userval="' + val.userid + '" class="btn save sh' + val.mid + '" value="Send">&nbsp;&nbsp;&nbsp;<input type="button" id="closereply" class="btn save" value="Close" idval="' + val.mid + '">'
                            '</div>' +
                            ' </div>' +
                            ' </div>' +
