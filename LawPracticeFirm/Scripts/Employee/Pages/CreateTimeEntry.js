...
//var timestamp2 = new Date(input2.hours2, input2.minutes2, input2.seconds2);
...
function timesr() {
    ...
    t = window.setInterval(function () {
        ...
        //alert(document.getElementById('countdown2').innerHTML);
...
$(document).ready(function () {
    //alert(localStorage.getItem("timerdata"));
    //  CKEDITOR.instances['details'].setData("hi");
    ...
    //alert(localStorage.getItem("timervalue"));
...
$('form[id="savecallform2"]').validate({
    ...
    submitHandler: function (form) {
        ...
        //var patt4 = /[0-9]{1}[:][0-9]{1}[:][0-9]{1}$/m;
        //var result2 = String(duration).match(patt4);
        //alert(result1);
        if (result1 == null) {
            ...
            $.ajax(
                {
                    ...
                    url: "/api/callApi/PostSaveTimeEntry", // Controller/View
                    data: formData,
