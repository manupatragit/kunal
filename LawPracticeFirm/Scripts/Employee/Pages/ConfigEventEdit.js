            ...
            success: function (response) {
                if (response.Status == true) {
                    ...
                    $.each(obj, function (i, val) {
                        ...
                        var option6 = '<option value="' + val.tauser + '" selected > ' + val.UserName + ' </option>';
                        $("#auser").append(option6);
                        var option7 = '<option value="' + val.tstatus + '" selected > ' + val.tstatus + ' </option>';
                        $("#status1").append(option7);
                        if (val.eallday == "1") {
