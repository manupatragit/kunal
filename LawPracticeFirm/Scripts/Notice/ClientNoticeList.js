...
$(document).ready(function () {
    ...
    bindcalender();
/*Bind client notice list details*/
...
/*Get manager list*/
    ...
    $("#savenotificationsettings").click(function () {
        ...
        //var txtalrtbefore = $("#txtalertbefore").val();
...
$(document).on("click", "#ViewDetails", function () {
    var noticeids = $(this).attr("data-id");
    ...
    if (type == "Notice") {
        ...
        url_redirect({
            url: urls,
            method: "post",
            data: { "NoitceId": noticeids }
        });
    }
    else if (type == "ReceivedNotice") {
        ...
        var urls = "/" + fcode + "/RejoinderNotice/RejoinderHome";
        url_redirect({
            url: urls,
            method: "post",
            data: { "NoitceId": noticeids }
...
/*Get client notice list details*/
var callapi = function () {
    ...
    $.ajax({
        type: "POST",
        url: '/api/NoticeReceived/ClientNoticeList',
        contentType: false,
        processData: false,
        data: formData,
            ...
            if (response == "") {
                ...
                if (1 == 1) {
                    ...
                    $.each(response, function (i, a) {
                        ...
                        html += "<tr>";
                        html += "<td class='type'>" + a.TypeofNotice + "</td>";
                        html += "<td class='noticesubject'><span style='color:#069;Cursor:pointer;' title='View Notice' data-id='" + a.NoticeID + "' type='" + a.TypeofNotice + "' id='ViewDetails'>" + a.Subject +  "</span ></td>";
                        html += "<td class='noticetitle'>" + a.NoticeTitle + "</td>";
                        html += "<td class='statutory'>" + a.NoticeType + "</td>";
                        html += "<td class='pending'>" + a.CaseStatus + "</td>";
                        html += "<td class='rejoinderthrough'>" + a.ClientName + "</td>";
                        html += "<td class='CreatedBy'>" + a.CreatedBy + "</td>";
                        html += "<td class='dateofcreating'>" + (a.Created_Date == null ? ' ' : dateFormat(new Date(a.Created_Date))) + "</td>";
                        html += "<tr>";
                    });
