...
var callapi = function () {
    ...
    $.ajax({
        type: "POST",
        url: "/api/NoticeNew/ConvertToCaseNoticeList",
        contentType: false,
        processData: false,
        data: formData,
...
function MoveToArchive(noticeid) {
    if (confirm("Are you sure you want to retrieve from archive this notice?")) {
        var formData = new FormData();
        formData.append("archivenoticeid", noticeid);
...
$("#savereplytonotice").click(function () {
    ...
    formData.append("txtreplyreciveddate", txtreplyreciveddate);
    formData.append("txtreplyrecivedthrough", txtreplyrecivedthrough);
    formData.append("hiddenreplynoticeid", $("#hiddenreplynoticeid").val());
    formData.append("txtsetreplydate", txtsetreplydate);
    $.ajax({
        type: "POST",
...
/*Save final convert to case notice status*/
$("#savefinalstatus").click(function () {
    ...
    formData.append("dateofddel", dateofddel);
    formData.append("txtdateofreceipt", txtdateofreceipt);
    formData.append("currentstatus", currentstatus);
    formData.append("NoticeId", noticeIdFinalStatus);
    formData.append("NoticeType", "NewNoticeDocument");
    $.ajax({
        type: "POST",
...
function ViewMoreItem1(parentId) {
    if (childtblclickcount1 == 1) {
        ...
        formData.append("incomingreplyid", "");
        var html = '';
        $.ajax({
            type: "POST",
...
function IncomingEditNotice(incomingreplyid) {
    ...
    formData.append("incomingreplyid", incomingreplyid);
    $.ajax({
        type: "POST",
        url: '/api/NoticeNew/IncomingNotice',
        contentType: false,
...
$("#assignnoticebtn").click(function () {
    if (confirm("Are you sure you want to send this Notice?")) {
        ...
        formData.append("noticeid", noticeid);
        formData.append("approvarType", approvarType);
        $.ajax({
            type: "POST",
...
/*Delete convert to case notice*/
var DeleteNotice = function () {
    formdata = new FormData();
    formdata.append("NoticeId", DelNoticeId)
    $.ajax({
        type: "POST",
