...
/*Get notice status for received archive notice list dropdown*/
...
/*Bind notice details for received archive notice list*/
function callapi() {
    openload();
    var html = '';
                ...
                if (1 == 1) {
                    ...
                    $.each(response, function (i, a) {
                        ...
                        if (a.IsReplyReceivedCount > 0) {
                            html += "<td class='sendernames'>" + a.SendersName + "  <span class='glyphicon glyphicon-chevron-down' title='View more item' style='cursor:pointer; ' onclick=ViewMoreItem('" + a.NoticeID + "') ></span ></td>";
                        } else {
                        ...
                        if (a.IsFileAvailable) {
                            html += '<td class="attachment"> <i title="View document" aria-hidden="true" id="incomingnoticerelevantdoc" style="cursor:pointer; textalign:center;color:#fd7e14;" id-val="' + a.NoticeID + '" id-type="ReceivedNotice"><img src="/newassets/img/folder-icon.png"></i></td>';
                        }
                        else {
                        ...
                        if (roleid == "3") {
                            ...
                            html += '<td>';
                            html += '<a style="cursor:pointer;" onclick=MoveToArchive("' + a.NoticeID + '") title = "Unarchive"><img src="/newassets/img/unarchive.png" /></a> <a style="cursor:pointer;"  onclick=fnviewlog("' + a.NoticeID + '","3") title="View Feedback"><img src="/newassets/img/causelist-icon.png" /></a>';
                        }
                        html += "<tr>";
                    });
...
/*Bind reply detail in received notice*/
        ...
        <thead style=" text-align:center;">
            <tr>
                           <th class="childtbltreplycls"><div class="thbg">No</div></th>
                            ...
                            <th class="tags" data-column="Tag" data-order="desc"><div class="thbg">Tags</th>
                ...
                if (response1 == "") {
                    ...
                    if (1 == 1) {
                        $.each(response1, function (i, a) {
                            ...
                            html += "<td  class='replythrough'>" + a.NoticeThrough + "</td>";
                            html += "<td class='noticetitle'>" + a.NoticeTitle + "</td>";
...
/*Bind rejoinder notice in received archive notice list*/
