...
namespace LawPracticeFirm.Common
{
    public class FirmControllerAuthorizationAttribute : AuthorizeAttribute
    {
        ...
        protected override void HandleUnauthorizedRequest(AuthorizationContext filterContext)
        {
            ...
            {
                filterContext.Result = new RedirectToRouteResult(new RouteValueDictionary(new { controller = "Account", action = "Login",RedirectUrl= filterContext.RequestContext.HttpContext.Request.CurrentExecutionFilePath }));
            }
        }
    }
}