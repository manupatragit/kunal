...
namespace BussinessLogic
{
    public class ESignCloud
    {
        ...
        /// <returns></returns>
        public static byte[] DecryptJsonDataAES(byte[] toDecrypt, byte[] key, string userid, string signtype, string docnum, string docname, string Referencenumber, string Transactionnumber, string firmid, string username, string Filetype, string Uid, string Cordinatetype)
        {
...
#pragma warning restore CS0168 // The variable 'er' is declared but never used
            ...
            var result = db.sp_SaveDigitalSignatureInfoCloud(Convert.ToBase64String(key), newfilename, folderpathazure, userid, docnum, docname, Transactionnumber, Referencenumber, signtype, firmid, username, Filetype, Uid, Cordinatetype);
            return output;
        }
    }

    public class DigitalSignatureCloudModal
    {
    ...
    public class DigitalSignatureCloud
    {
